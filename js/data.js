...
const skillBaseData = {
    "Concentration": { name: "Concentration", maxXp: 100, heroxp: 36, effect: 0.01, description: "技能經驗" },
    "Productivity": { name: "Productivity", maxXp: 100, heroxp: 37, effect: 0.01, description: "英雄經驗" },
    "Bargaining": { name: "Bargaining", maxXp: 100, heroxp: 38, effect: -0.01, description: "降低開支" },
    "Meditation": { name: "Meditation", maxXp: 100, heroxp: 39, effect: 0.01, description: "幸福度" },

    "Strength": { name: "Strength", maxXp: 100, heroxp: 40, effect: 0.01, description: "軍事報酬" },
    "Battle Tactics": { name: "Battle Tactics", maxXp: 100, heroxp: 41, effect: 0.01, description: "軍事經驗" },
    "Muscle Memory": { name: "Muscle Memory", maxXp: 100, heroxp: 42, effect: 0.01, description: "力量經驗" },

    "Mana Control": { name: "Mana Control", maxXp: 100, heroxp: 46, effect: 0.01, description: "奧術協會經驗" },
    "Life Essence": { name: "Life Essence", maxXp: 100, heroxp: 82, effect: 0.01, description: "延長壽命" },
    "Time Warping": { name: "Time Warping", maxXp: 100, heroxp: 82, effect: 0.01, description: "遊戲速度" },
    "Astral Body": { name: "Astral Body", maxXp: 100, heroxp: 100, effect: 0.0035, description: "延長壽命" },
    "Temporal Dimension": { name: "Temporal Dimension", maxXp: 100, heroxp: 115, effect: 0.006, description: "遊戲速度" },
    "All Seeing Eye": { name: "All Seeing Eye", maxXp: 100, heroxp: 120, effect: 0.0027, description: "奧術協會報酬" },
    "Brainwashing": { name: "Brainwashing", maxXp: 100, heroxp: 145, effect: -0.01, description: "降低開支" },

    "Dark Influence": { name: "Dark Influence", maxXp: 100, heroxp: 155, effect: 0.01, description: "所有經驗" },
    "Evil Control": { name: "Evil Control", maxXp: 100, heroxp: 156, effect: 0.01, description: "邪惡增益" },
    "Intimidation": { name: "Intimidation", maxXp: 100, heroxp: 157, effect: -0.01, description: "降低開支" },
    "Demon Training": { name: "Demon Training", maxXp: 100, heroxp: 174, effect: 0.01, description: "所有經驗" },
    "Blood Meditation": { name: "Blood Meditation", maxXp: 100, heroxp: 176, effect: 0.01, description: "邪惡增益" },
    "Demon's Wealth": { name: "Demon's Wealth", maxXp: 100, heroxp: 178, effect: 0.002, description: "英雄報酬" },
    "Dark Knowledge": { name: "Dark Knowledge", maxXp: 100, heroxp: 180, effect: 0.003, description: "英雄經驗" },

    "Void Influence": { name: "Void Influence", maxXp: 100, heroxp: 206, effect: 0.0028, description: "所有經驗" },
    "Time Loop": { name: "Time Loop", maxXp: 100, heroxp: 207, effect: 0.001, description: "遊戲速度" },
    "Evil Incarnate": { name: "Evil Incarnate", maxXp: 100, heroxp: 208, effect: 0.01, description: "技能經驗" },
    "Absolute Wish": { name: "Absolute Wish", maxXp: 100, heroxp: 198, effect: 0.005, description: "邪惡增益" },
    "Void Amplification": { name: "Void Amplification", maxXp: 100, heroxp: 251, effect: 0.01, description: "虛空經驗" },
    "Mind Release": { name: "Mind Release", maxXp: 100, heroxp: 251, effect: 0.0006, description: "增加幸福度" },
    "Ceaseless Abyss": { name: "Ceaseless Abyss", maxXp: 100, heroxp: 251, effect: 0.000585, description: "延長壽命" },
    "Void Symbiosis": { name: "Void Symbiosis", maxXp: 100, heroxp: 253, effect: 0.0015, description: "技能經驗" },
    "Void Embodiment": { name: "Void Embodiment", maxXp: 100, heroxp: 258, effect: 0.0025, description: "邪惡增益" },
    "Abyss Manipulation": { name: "Abyss Manipulation", maxXp: 100, heroxp: 266, effect: -0.01, description: "降低開支" },

    "Cosmic Longevity": { name: "Cosmic Longevity", maxXp: 100, heroxp: 266, effect: 0.0015, description: "延長壽命" },
    "Cosmic Recollection": { name: "Cosmic Recollection", maxXp: 100, heroxp: 272, effect: 0.00065, description: "最高等級倍數" },
    "Essence Collector": { name: "Essence Collector", maxXp: 100, heroxp: 288, effect: 0.01, description: "精華增益" },
    "Galactic Command": { name: "Galactic Command", maxXp: 100, heroxp: 290, effect: -0.01, description: "降低開支" },

    "Yin Yang": { name: "Yin Yang", maxXp: 100, heroxp: 290, effect: 0.020, description: "精華 + 邪惡增益" },
    "Parallel Universe": { name: "Parallel Universe", maxXp: 100, heroxp: 300, effect: 0.02, description: "所有經驗" },
    "Higher Dimensions": { name: "Higher Dimensions", maxXp: 100, heroxp: 300, effect: 0.001, description: "延長壽命" },
    "Epiphany": { name: "Epiphany", maxXp: 100, heroxp: 280, effect: 0.012, description: "銀河理事會經驗" },

    "Dark Prince": { name: "Dark Prince", maxXp: 100, heroxp: 350, effect: 0.01, description: "技能經驗" },
    "Dark Ruler": { name: "Dark Ruler", maxXp: 100, heroxp: 375, effect: 0.0000015, description: "暗物質增益" },
    "Immortal Ruler": { name: "Immortal Ruler", maxXp: 100, heroxp: 425, effect: 0.01, description: "所有經驗" },
    "Dark Magician": { name: "Dark Magician", maxXp: 100, heroxp: 475, effect: 0.0000025, description: "精華增益" },
    "Universal Ruler": { name: "Universal Ruler", maxXp: 100, heroxp: 500, effect: 1, description: "魔法經驗" },
    "Blinded By Darkness": { name: "Blinded By Darkness", maxXp: 100, heroxp: 550, effect: 1, description: "所有經驗" },
}
...
const itemBaseData = {
    ...
    // Misc
    "Book": { name: "Book", expense: 10, effect: 1.5, description: "技能經驗", heromult: 2, heroeffect: 10 },
    "Dumbbells": { name: "Dumbbells", expense: 50, effect: 1.5, description: "力量經驗", heromult: 2, heroeffect: 10 },
    "Personal Squire": { name: "Personal Squire", expense: 200, effect: 2, description: "英雄經驗", heromult: 3, heroeffect: 10 },
    "Steel Longsword": { name: "Steel Longsword", expense: 1000, effect: 2, description: "軍事經驗", heromult: 3, heroeffect: 10 },
    "Butler": { name: "Butler", expense: 7500, effect: 1.5, description: "幸福度", heromult: 4, heroeffect: 10 },
    "Sapphire Charm": { name: "Sapphire Charm", expense: 50000, effect: 3, description: "魔法經驗", heromult: 4, heroeffect: 10 },
    "Study Desk": { name: "Study Desk", expense: 1000000, effect: 2, description: "技能經驗", heromult: 5, heroeffect: 10 },
    "Library": { name: "Library", expense: 1e7, effect: 2, description: "技能經驗", heromult: 5, heroeffect: 10 },
    "Observatory": { name: "Observatory", expense: 1.4e8, effect: 5, description: "魔法經驗", heromult: 6, heroeffect: 10 },
    "Mind's Eye": { name: "Mind's Eye", expense: 3.25e9, effect: 10, description: "基礎經驗", heromult: 8, heroeffect: 10 },
    "Void Necklace": { name: "Void Necklace", expense: 2.8e10, effect: 3, description: "虛空操控經驗", heromult: 10, heroeffect: 10 },
    "Void Armor": { name: "Void Armor", expense: 1.97e11, effect: 3, description: "虛空經驗", heromult: 10, heroeffect: 10 },
    "Void Blade": { name: "Void Blade", expense: 5e11, effect: 3, description: "技能經驗", heromult: 11, heroeffect: 10 },
    "Void Orb": { name: "Void Orb", expense: 1.2e12, effect: 3, description: "虛空操控經驗", heromult: 11, heroeffect: 10 },
    "Void Dust": { name: "Void Dust", expense: 2.5e13, effect: 3, description: "虛空經驗", heromult: 12, heroeffect: 10 },
    "Celestial Robe": { name: "Celestial Robe", expense: 3e14, effect: 5, description: "銀河理事會經驗", heromult: 12, heroeffect: 10 },
    "Universe Fragment": { name: "Universe Fragment", expense: 1.85e16, effect: 3, description: "技能經驗", heromult: 13, heroeffect: 1000000 },
    "Multiverse Fragment": { name: "Multiverse Fragment", expense: 2e17, effect: 5, description: "幸福度", heromult: 15, heroeffect: 1000000 },
    "Stairway to heaven": { name: "Stairway to heaven", expense: 1e38, effect: 10, description: "幸福度", heromult: 30, heroeffect: 1000000 },
    "Highway to hell": { name: "Highway to hell", expense: 1e42, effect: 10, description: "邪惡增益", heromult: 30, heroeffect: 1000000 },
    "Tesseract": { name: "Tesseract", expense: 1e48, effect: 1, description: "超立方體增益", heromult: 30, heroeffect: 10 },
    "Desintegration": { name: "Desintegration", expense: 1e55, effect: 1, description: "暗物質增益", heromult: 30, heroeffect: 100 },
    "Custom Galaxy": { name: "Custom Galaxy", expense: 1e64, effect: 1, description: "技能經驗", heromult: 30, heroeffect: 1e100 },
    "Hypersphere": { name: "Hypersphere", expense: 1e91, effect: 1, description: "超立方體增益", heromult: 30, heroeffect: 1e50 },
}
